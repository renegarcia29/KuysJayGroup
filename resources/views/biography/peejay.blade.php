<x-layout title="Jaypee Biography">
  ...
  <section id="home" class="hero-gradient min-h-screen flex items-center justify-center text-white pt-20">
    <div class="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center">
      <div class="md:w-1/2 mb-10 md:mb-0 animate-fade">
        <h1 class="text-4xl md:text-6xl font-bold mb-6">Hello, I'm <span class="text-cyan-300"><br>Peejay Labador</span></h1>
      ...
      <div class="md:w-1/2 flex justify-center animate-fade">
        <div class="relative rounded-full overflow-hidden border-4 border-white shadow-2xl w-64 h-64 md:w-80 md:h-80">
          <img src="{{ asset('pictures/kuys.png') }}" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="flex flex-col md:flex-row">
        <div class="md:w-1/2 mb-10 md:mb-0 md:pr-10 animate-fade">
          ...
          <p class="mb-6">I'm Peejay Labador, 20 years old, living in Old Central Sudipen La Union, pursuing a Bachelor of Science in Information Technology (BSIT).</p>
        ...
        <div class="md:w-1/2 animate-fade">
          ...
          <div class="space-y-4">
            <div><span class="font-bold mr-2">Name:</span>Peejay A. Labador</div>
            <div><span class="font-bold mr-2">Age:</span>20 years old</div>
            <div><span class="font-bold mr-2">Location:</span>Old Central Sudipen La Union </div>
          </div>
          <div class="mt-8">
      ...
      <div class="relative timeline">
        ...
        <div class="relative pl-10 pb-10 timeline-item">
          <div class="bg-white p-6 rounded-lg shadow-lg hover-grow">
            ...
            <p class="mb-4">I Attended Old Sudipen Elementary School where i studied my elementary days and graduated elementary (2009 - 2015), I also Attended Tagduin National High School (TNHS) where I studied TVL Home Economics (2019 - 2022). This period was crucial for developing my skills in cooking, then I Attended Ilocos Sur Polytechnic State College in Tagudin Ilocos sure where i study BSIT and still ongoing (2023 - Present)</p>
            <div class="flex overflow-x-auto gap-8 pb-2">
