...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Jaypee Biography']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Jaypee Biography']); ?>
  <script src="https://cdn.tailwindcss.com"></script>
  <link rel="shortcut icon" href="<?php echo e(asset('img/ispsc.png')); ?>" type="image/x-icon" />
  <style>
    ...
    <div class="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center">
      ...
      <div class="md:w-1/2 flex justify-center animate-fade">
        <div class="relative rounded-full overflow-hidden border-4 border-white shadow-2xl w-64 h-64 md:w-80 md:h-80">
          <img src="<?php echo e(asset('pictures/kuys.png')); ?>" />
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="mt-8">
            ...
            <div class="grid grid-cols-3 gap-4">
              <div class="flex flex-col items-center">
                <div class="bg-indigo-100 p-4 rounded-full mb-2"><img src="<?php echo e(asset('pictures/edit.png')); ?>" /></div>
                <span>Video Editing</span>
              </div>
              <div class="flex flex-col items-center">
                <div class="bg-pink-100 p-4 rounded-full mb-2"><img src="<?php echo e(asset('pictures/sports.png')); ?>" /></div>
                <span>Sports</span>
              </div>
              <div class="flex flex-col items-center">
                <div class="bg-green-100 p-4 rounded-full mb-2"><img src="<?php echo e(asset('pictures/manga.png')); ?>" /></div>
                <span>Reading</span>
              </div>
            </div>
          </div>
      ...
      <div class="relative timeline">
        ...
        <div class="relative pl-10 pb-10 timeline-item">
          <div class="bg-white p-6 rounded-lg shadow-lg hover-grow">
            ...
            <div class="flex overflow-x-auto gap-8 pb-2">
              <img src="<?php echo e(asset('pictures/jardin.png')); ?>" class="rounded-lg" />
              <img src="<?php echo e(asset('pictures/arc.png')); ?>" class="rounded-lg" />
        ...
        <div class="relative pl-10 pb-10 timeline-item">
          <div class="bg-white p-6 rounded-lg shadow-lg hover-grow">
            ...
            <div class="flex overflow-x-auto gap-8 pb-2">
                <img src="<?php echo e(asset('pictures/ls.png')); ?>" class="rounded-lg" />
                <img src="<?php echo e(asset('pictures/tn.png')); ?>" class="rounded-lg" />
                <img src="<?php echo e(asset('pictures/is.png')); ?>" class="rounded-lg" />
            </div>
          </div>
        </div>
        ...
        <div class="relative pl-10 timeline-item">
          <div class="bg-white p-6 rounded-lg shadow-lg hover-grow">
            ...
            <div class="flex overflow-x-auto gap-8 pb-2">
              <img src="<?php echo e(asset('pictures/it.jpg')); ?>" class="rounded-lg" />
            </div>
          </div>
        </div>
      </div>
...
<?php endif; ?><?php /**PATH C:\Users\Kurt\Laravel\Laravel\resources\views/biography/jaypee.blade.php ENDPATH**/ ?>